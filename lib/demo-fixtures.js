...
export const PIPELINE = {
  stages: {
    ...
    Converted: 12, Lost: 3, Ghosted: 2, Disqualified: 1,
  },
  stageOrder: ["Incoming","Contacted","Qualified","Discovery Booked","Discovery Done","Converted","Lost","Ghosted","Disqualified"],
  ...
  lostLabel: "Lost", lostLabels: ["Lost","Ghosted","Disqualified"],
  totalLostLeads: 6,
  sources: [
  ...
  stageValues: { Incoming: 26000, Contacted: 16250, Qualified: 13000, "Discovery Booked": 9750, "Discovery Done": 19500, Converted: 39000, Lost: 9750, Ghosted: 6500, Disqualified: 3250 },
...
export const DEALS = {
  stages: {
    Incoming: 3, "Discovery Done": 2, "Proposal Sent": 2,
    "Quotation Issued": 1, "Awaiting Deposit": 2,
    Building: 4, "Balance Due": 1, Delivered: 9, Lost: 2,
  },
  stageOrder: ["Incoming","Discovery Done","Proposal Sent","Quotation Issued","Awaiting Deposit","Building","Balance Due","Delivered","Lost"],
  potentialStages: ["Incoming","Discovery Done","Proposal Sent","Quotation Issued","Awaiting Deposit"],
  wonStages: ["Building","Balance Due","Delivered"],
  ...
  lostLabel: "Lost", lostLabels: ["Lost"],
  wonThisMonth: 2, deliveredThisMonth: 1,
  wonValue: 58500, lostValue: 6500,
  proposals: { total: 5, Draft: 1, "Send Proposal": 0, Sent: 2, Accepted: 2, Rejected: 0, pipelineValue: 36000 },
  ...
  stageValues: { Incoming: 9750, "Discovery Done": 6500, "Proposal Sent": 12250, "Quotation Issued": 3250, "Awaiting Deposit": 12250, Building: 24500, "Balance Due": 3250, Delivered: 29250, Lost: 6500 },
}
...
export const FINANCE = {
  ...
  topProducts: [
    { pkg: "Business OS", count: 5, value: 45000, cat: "os", sub: "Revenue + Operations" },
    { pkg: "Revenue OS", count: 4, value: 13000, cat: "os", sub: "Lead to cash — full cycle" },
    { pkg: "Operations OS", count: 3, value: 9750, cat: "os", sub: "Workflow & delivery" },
    { pkg: "Marketing OS", count: 2, value: 6500, cat: "os", sub: "Campaigns, content & ads" },
    { pkg: "Enhanced Dashboard", count: 3, value: 4500, cat: "widgets", sub: "Charts, trends & KPI cards" },
  ],
}
