...
const CSS = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  :root{
    --bg:#F5F2EB;--black:#111111;--white:#FFFFFF;
  ...
  html{font-size:14px;background:#DEDAD3}
  body{font-family:var(--fb);color:var(--fg);background:#DEDAD3;-webkit-font-smoothing:antialiased}
  ...
  @media print{
    *{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}
    ...
    .page{margin:0!important;box-shadow:none!important;width:100%!important;height:297mm;overflow:hidden;page-break-after:always;background:var(--bg)!important}
    .page:last-of-type{page-break-after:auto}
    .phase2-item,.os-block,.addon-item-row{page-break-inside:avoid;break-inside:avoid;-webkit-column-break-inside:avoid}
  }

  /* ── Page content area ──────────────────────────────────────────────────── */
  .page-body{padding:52px 60px 0;flex:1}
  ...
  /* ── Page 3 — Investment ────────────────────────────────────────────────── */
  .inv-heading{font-family:var(--fh);font-size:28px;font-weight:700;color:var(--black);margin-bottom:32px;letter-spacing:-.01em}
  ...
  .inv-terms{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:32px;padding-top:28px;border-top:1px solid var(--border)}
  ...
  /* ── Next steps ─────────────────────────────────────────────────────────── */
  .steps-heading{font-family:var(--fh);font-size:22px;font-weight:700;color:var(--black);margin-bottom:20px;letter-spacing:-.01em}
  .steps-list{display:flex;flex-direction:column;gap:0}
  .step-row{display:grid;grid-template-columns:48px 1fr;gap:16px;align-items:start;padding:16px 0;border-bottom:1px solid var(--border)}
  ...
  .step-text-desc{font-size:12.5px;color:#555551;line-height:1.6}

  /* ── CTA ────────────────────────────────────────────────────────────────── */
  .cta-strip{background:var(--black);margin:40px -60px 0;padding:36px 60px;display:flex;justify-content:space-between;align-items:center;gap:24px}
