...
export default async function handler(req, res) {
  ...
  const defaults = { "502736ebbe34829aada981e516950457": { name: "Maisarah", pw: "maisarah2026" } }
  ...
  for (const [id, info] of Object.entries(defaults)) {
    if (labels.workspace_staff[id]) {
      labels.workspace_staff[id] = { ...labels.workspace_staff[id], password_hash: bcrypt.hashSync(info.pw, 10), must_change: true, backup_code_hash: null }
    }
  }
