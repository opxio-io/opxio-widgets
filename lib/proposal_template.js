...
const CSS = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  /* ── Page 2 — System ────────────────────────────────────────────────────── */
  .p2-header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:36px}
  ...
  .p2-total-badge{background:var(--black);color:#fff;padding:13px 18px;border-radius:4px;text-align:right;flex-shrink:0;margin-left:24px}
  .p2-total-label{font-family:var(--fh);font-size:8px;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:rgba(255,255,255,.5);margin-bottom:5px}
  .p2-total-amount{font-family:var(--fh);font-size:19px;font-weight:700;color:#fff;white-space:nowrap}

  /* OS sections — name+price on one line */
  .os-section{padding:18px 0;border-top:1px solid var(--border);page-break-inside:avoid;break-inside:avoid}
  .os-name-row{display:flex;justify-content:space-between;align-items:center;margin-bottom:6px}
  .os-name{font-family:var(--fh);font-size:14.5px;font-weight:700;color:var(--black)}
  .os-comp-badge{font-size:9.5px;font-weight:600;color:#4A7A00;background:#EDFFD0;padding:2px 9px;border-radius:20px;margin-left:10px;display:inline-block;vertical-align:middle}
  .os-price-inline{font-family:var(--fh);font-size:14.5px;font-weight:700;color:var(--black);white-space:nowrap}
  .os-price-sub{font-size:9.5px;color:var(--muted);margin-left:6px;font-weight:400}
  .os-desc{font-size:11.5px;color:var(--muted);line-height:1.5;margin-bottom:10px}
  .module-pills{display:flex;flex-wrap:wrap;gap:4px}
  .module-pill{font-size:10px;color:#444440;background:#F2F2EF;padding:3px 9px;border-radius:3px;white-space:nowrap;line-height:1.5;border:1px solid #E8E8E2}

  /* Add-ons */
  .addons-wrapper{margin-top:28px}
  .addons-label{font-family:var(--fh);font-size:8.5px;font-weight:700;letter-spacing:.16em;text-transform:uppercase;color:var(--muted);margin-bottom:0;padding-bottom:10px;border-bottom:1px solid var(--border)}
  .addon-item{display:flex;justify-content:space-between;align-items:baseline;gap:16px;padding:10px 0;border-bottom:1px solid var(--border)}
  .addon-item-name{font-family:var(--fh);font-size:12px;font-weight:600;color:var(--black)}
  .addon-item-right{text-align:right;flex-shrink:0}
  .addon-item-price{font-family:var(--fh);font-size:12.5px;font-weight:700;color:var(--black)}
  .addon-item-cad{font-size:9.5px;color:var(--muted)}

  /* Also available */
  .also-later{margin-top:24px}
  ...
  .also-later-pill{font-size:10.5px;color:var(--muted);border:1px solid #E0E0DA;padding:3px 10px;border-radius:20px;white-space:nowrap}
...
<div class="page">
  <div class="page-body">
    ...
    <div class="os-section">
      <div class="os-name-row">
        <div>
          <span class="os-name">Base OS</span>
          <span class="os-comp-badge">Complimentary</span>
        </div>
      </div>
    ...
    ${osTypes.length ? osTypes.map(osName => {
      ...
      return `<div class="os-section">
        <div class="os-name-row">
          <div class="os-name">${escape(osName)}</div>
          <div><span class="os-price-inline">${displayPrice}</span><span class="os-price-sub">· one-time</span></div>
        </div>
        ${desc ? `<div class="os-desc">${escape(desc)}</div>` : ''}
