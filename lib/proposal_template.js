...
const CSS = `
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .phase2-grid{display:block;margin:28px 0}
  .phase2-item{display:grid;grid-template-columns:200px 1fr auto;gap:24px;align-items:start;padding:20px 24px;border:1px solid var(--g200);border-radius:4px;margin-bottom:12px;page-break-inside:avoid;break-inside:avoid;break-before:avoid}
