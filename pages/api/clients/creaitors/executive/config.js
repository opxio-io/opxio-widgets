...
const VALID_SECTIONS = ['campaign', 'content', 'crm', 'crm-log']
...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    ...
    // Merge into existing labels (preserves all other keys like stages, taskStatuses, etc.)
    ...
    if (error) {
      console.error('executive/config POST error:', error)
